class AsyncIndexScrapeBatchJob < ApplicationJob
  ...
  def perform(scrape_page_id)
    ...
    if pages_to_parse || pages_to_index
      ...
      Rails.logger.info "We just indexed, but still have pages to parse or index.   Not going to cache yet."
    else
      Rails.logger.info "We just indexed, and have nothing left to index. Let's cache."
